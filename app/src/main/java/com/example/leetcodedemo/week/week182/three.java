...
public class three {
    ...
    class UndergroundSystem {
        ...
        class Person{
            ...
            public Person(int id, String inStation, int inT) {
                this.id = id;
        ...
        public void checkIn(int id, String stationName, int t) {
            Person person = new Person(id, stationName, t);
            if (!stationMap.containsKey(stationName))
                stationMap.put(stationName, new Station());
            personMap.put(id, person);
        }

        public void checkOut(int id, String stationName, int t) {
            Person person = personMap.get(id);
            Station station = stationMap.get(person.inStation);
//            if (s)
//            stationMap.put(inStation, )
        }
